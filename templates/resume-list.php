                ...
                <div class="vakancy-page-block company-list-search__block resume-list__block p-rel mb16">
                    <div class="company-list-search__block-left">
                        <div class="resume-list__block-img mb8">
                            <img src="<?php echo $data["photo"] ?>" alt="profile">
                        </div>
                    </div>
                    <div class="company-list-search__block-right">
                        <div class="mini-paragraph cadet-blue mobile-mb12"><?php echo date("Обновлено j ".$months[date( 'n' )]." Y в H:i",$data["date"]) ?></div>
                        <h3 class="mini-title mobile-off"><?php echo $data["name"] ?></h3>
                        <div class="d-flex align-items-center flex-wrap mb8 ">
                            <span class="mr16 paragraph"><?php echo $data["price"] ?> ₽</span>
                            <span class="mr16 paragraph"><?php echo $data["workyear"] ?></span>
                            <span class="mr16 paragraph"><?php echo $data["yearold"] ?> года</span>
                            <span class="mr16 paragraph"><?php echo $data["location"] ?></span>
                        </div>
                        <p class="paragraph tbold mobile-off">Последнее место работы</p>
                    </div>
                    <div class="company-list-search__block-middle">
                        <h3 class="mini-title desktop-off"><?php echo $data["name"] ?></h3>
                        <p class="paragraph mb16 mobile-mb32"><?php echo $data["oldlocwork"] ?> </p>
                    </div>
                </div>
                <?php endforeach; ?>
